...
class Settings:
    ...
    ASK_AI_MODEL = os.getenv("ASK_AI_MODEL", OPENAI_MODEL).strip()
    ASK_AI_TIMEOUT_SECONDS = float(os.getenv("ASK_AI_TIMEOUT_SECONDS", "20"))
    ASK_AI_MAX_INPUT_CHARS = int(os.getenv("ASK_AI_MAX_INPUT_CHARS", "18000"))
    ASK_AI_MAX_OUTPUT_TOKENS = int(os.getenv("ASK_AI_MAX_OUTPUT_TOKENS", "1800"))
    ASK_AI_REASONING_EFFORT = os.getenv("ASK_AI_REASONING_EFFORT", "low").strip().lower()
